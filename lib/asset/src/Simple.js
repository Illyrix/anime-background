...
var Simple = function() {
    ...
    let dir_dom = document.getElementById("getDirPath");
    let _dir_name = dir_dom.getAttribute("dir");

    // Epsilon 2.1モデル
    this.modelDef = {
        "type":"Live2D Model Setting",
        "name":"Epsilon2.1",
        "model": _dir_name + "/asset/assets/Epsilon2.1/Epsilon2.1.moc",
        "textures":[
            _dir_name + "/asset/assets/Epsilon2.1/Epsilon2.1.2048/texture_00.png",
        ]
    };
